...
class TransactionViewController: BaseViewController {
    ...
    @IBOutlet var btnSelectTransaction: AkuratecoButton!
    @IBOutlet var btnLoadAll: AkuratecoButton?
    @IBOutlet var lbSelectedTransaction: UILabel!
    
    private(set) var selectedTransaction: AkuratecoTransactionStorage.Transaction?
    var transactions: [AkuratecoTransactionStorage.Transaction] = [] {
        didSet {
            setTansaction(nil)
    ...
    @objc func selectTransaction() {
        let chooserVC = AkuratecoChooserVC<AkuratecoTransactionStorage.Transaction>()
    ...
    func setTansaction(_ transaction: AkuratecoTransactionStorage.Transaction?) {
