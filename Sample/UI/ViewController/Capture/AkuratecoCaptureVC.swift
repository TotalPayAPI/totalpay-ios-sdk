...
final class AkuratecoCaptureVC: TransactionViewController {
    ...
    private lazy var catpureAdapter: AkuratecoCaptureAdapter = {
        let adapter = AkuratecoAdapterFactory().createCapture()
