...
///
/// See *AkuratecoCard*
public struct AkuratecoTestCard {
    ...
    public static var saleSuccess: AkuratecoCard {
        AkuratecoCard(number: testCardNumber, expireMonth: 1, expireYear: testCardYear, cvv: testCardCvv)
    }
    ...
    public static var saleFailure: AkuratecoCard {
        AkuratecoCard(number: testCardNumber, expireMonth: 2, expireYear: testCardYear, cvv: testCardCvv)
    }
    ...
    public static var captureFailure: AkuratecoCard {
        AkuratecoCard(number: testCardNumber, expireMonth: 3, expireYear: testCardYear, cvv: testCardCvv)
    }
    ...
    public static var secure3dSuccess: AkuratecoCard {
        AkuratecoCard(number: testCardNumber, expireMonth: 5, expireYear: testCardYear, cvv: testCardCvv)
    }
    ...
    public static var secure3dFailure: AkuratecoCard {
        AkuratecoCard(number: testCardNumber, expireMonth: 6, expireYear: testCardYear, cvv: testCardCvv)
    }
