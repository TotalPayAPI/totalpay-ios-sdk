...
/// SALE Service for the *AkuratecoSaleAdapter*.
/// 
...
public struct AkuratecoSaleService: XWWWFormUrlEncodable {
    let action = AkuratecoAction.sale
    ...
    let recurringInit: AkuratecoOption?
    let auth: AkuratecoOption?
    let hash: String
}

extension AkuratecoSaleService: Encodable {
